...
<body>
  ...
  <div id="navi-container">
	...
	<table class="table1">
		<tr>
			<td><img alt="gom_disco" src="resources/images/gom_disco.png"
				height="500" width="500"></td>
		</tr>
		<tr>
			<td><a class="disco" style="color: #C56834;">디스코를 좋아하는 당신은
					아몬드 봉봉!</a></td>
		</tr>
		<tr>
			<td><a class="disco" style="color: #C56834;">D.I.S.C.O 미친듯이
					춤추고 봉봉!!</a></td>
		</tr>
	</table>
	<br>
