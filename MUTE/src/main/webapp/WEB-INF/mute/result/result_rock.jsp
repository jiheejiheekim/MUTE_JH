...
<body>
  ...
  <div id="navi-container">
	...
	<table class="table1">
		<tr>
			<td><img alt="gom_rock" src="resources/images/gom_rock.png"
				height="500" width="500"></td>
		</tr>
		<tr>
			<td><a class="rock" style="color: #5EA9EF;">락을 좋아하는 당신은
					슈팅스타!</a></td>
		</tr>
		<tr>
			<td><a class="rock" style="color: #5EA9EF;">손 머리 위로 Hands
					Up!</a></td>
		</tr>
	</table>
	<br>
	...
	<div class="con">
		<div class="reco">
			<br> <a class="tag">당신을 위한 #락 음악</a><br>
			<br>
			<table class="table2">
			<tr id="trhead">
				<td></td>
