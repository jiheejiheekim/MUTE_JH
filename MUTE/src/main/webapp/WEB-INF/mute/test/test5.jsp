	...
	<a href="main"><img class="logo" src="resources/images/mutelogo.png"></a>
		...
		<div class="question">
	    	<h1>Q5.<br> 첫 눈이 내린 날, <br>당신이 들을 노래는?</h1>
		        ...
		        <button class="btn" onclick="selectGenre(1)" onmouseover="addShadow(this)" onmouseout="removeShadow(this)">Snowman - SIA</button>
		        <button class="btn" onclick="selectGenre(2)" onmouseover="addShadow(this)" onmouseout="removeShadow(this)">All I Want For Christmas Is You - Mariah Carey</button>
		        <button class="btn" onclick="selectGenre(3)" onmouseover="addShadow(this)" onmouseout="removeShadow(this)">Last Christmas - Wham!</button>
		        <button class="btn" onclick="selectGenre(4)" onmouseover="addShadow(this)" onmouseout="removeShadow(this)">Santa Tell Me - Ariana Grande</button>
	    </div>
</div>
	   ...
	   /* 보기 버튼에 마우스 올리면 그림자 생김 */
        ...
        function selectGenre(value) {
            if (value === 1) {	/* 인덱스 증가 처리 */
	       	...
	       	window.location.href = `test6`;// test5에서 해당 장르 배열 인덱스 값 증가 후 스크립트 내에서 페이지 이동
        }//------------------------------------
